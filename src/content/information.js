...
const userData = {
  ...
  description: `Hey there! 👋 I'm Toyosi, a certified Vue.js developer and highly skilled Web Developer with over ${yearsOfExp}+ years of experience in web development, specializing in creating dynamic and scalable web applications. For the past ${
    yearsOfExp - 3
  }+ years, my expertise has been focused on Frontend development, building complex projects using Vue.js, React.js, and Vanilla JavaScript and TypeScripy. My deep understanding of the Vue and React ecosystems enables me to leverage a wide range of their tools and frameworks to deliver high-performance, maintainable solutions. Additionally, I have hands-on experience with backend technologies, allowing me to approach frontend development with a full-stack perspective.`,
};
